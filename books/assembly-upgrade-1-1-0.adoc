...
. Second, you configure all Kafka brokers to use the previous protocol versions.
.. xref:proc-updating-kafka-brokers-to-previous-protocol-versions-{context}[Updating Kafka brokers to the previous protocol versions]
...
In order to upgrade brokers and clients without downtime you need to complete the upgrade procedures in the order given above.
