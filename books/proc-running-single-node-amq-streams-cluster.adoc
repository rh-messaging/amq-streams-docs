...
WARN: Single node AMQ Streams cluster does not provide realibility and high availability and is suitable only for development purposes.
...
* For more information about installing AMQ Streams, see xref:proc-downloading-and-installing-amq-streams-{context}[].