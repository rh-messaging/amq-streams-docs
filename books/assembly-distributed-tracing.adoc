...
To configure distributed tracing, you __instrument__ Kafka clients and components using an OpenTracing client library. This involves adding instrumentation code that monitors the execution of individual transactions in order to generate trace data.
