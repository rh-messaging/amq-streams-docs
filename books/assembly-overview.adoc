...
It consists from 5 main components:
...
The broker itself uses Apache Zookeeper for storing configuration data and for cluster coordination (electing leaders, and so on). 
Before installing Apache Kafka, an Apache Zookeeper cluster has to be ready.
