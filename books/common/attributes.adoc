...
//Release Notes links
//To
:RelNotes: https://access.redhat.com/documentation/en-us/red_hat_amq/{BaseProductVersion}/html-single/amq_streams_1.2_on_openshift_container_platform_release_notes
//From
