...
The JConsole tool is distributed with the JDK (Java Development Kit). You can use JConsole to connect to a local or remote JVM and discover and display management information from Java applications.
