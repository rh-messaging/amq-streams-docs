...
[id='MBeans in the `kafka.connect` domain']

Attributes of MBeans `kafka.connect:type=connect-worker-metrics`
...
Attributes of MBeans `kafka.connect:type=connect-worker-rebalance-metrics`
...
Attributes of MBeans `kafka.connect:type=connector-metrics,connector="{connector}"`
...
Attributes of MBeans `kafka.connect:type=connector-task-metrics,connector="{connector}",task="{task}"`
...
Attributes of MBeans `kafka.connect:type=sink-task-metrics,connector="{connector}",task="{task}"`
...
Attributes of MBeans `kafka.connect:type=source-task-metrics,connector="{connector}",task="{task}"`
...
Attributes of MBeans `kafka.connect:type=task-error-metrics,connector="{connector}",task="{task}"`
