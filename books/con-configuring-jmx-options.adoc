...
The scripts provided with AMQ Streams (e.g. `bin/kafka-server-start.sh` and `bin/connect-distributed.sh`) use the `KAFKA_JMX_OPTS` environment variable to set these System properties.
