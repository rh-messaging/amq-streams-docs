...
Authorization in Kafka brokers is implemented using authorization plugins.
It is using Access Control Lists (ACLs) - a set of rules describing what uses can and cannot do.
Users can supply their own authorization plugins or use the built in _Simple ACL authorizer_.
